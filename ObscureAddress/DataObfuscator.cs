    ...
    public static class DataObfuscator
    {
        ...
        private static InvestorData TransformImpl(InvestorData investor)
        {
            ...
            var newInvestor = new InvestorData
            {
                Id = investor.Id,
                Name = investor.Name,
                Line1 = DataTransform(investor.Id, investor.Line1, 30),
                Line2 = DataTransform(investor.Id, investor.Line2, 30),
                Line3 = DataTransform(investor.Id, investor.Line3, 30),
                Line4 = DataTransform(investor.Id, investor.Line4, 30),
                Line5 = DataTransform(investor.Id, investor.Line5, 30),
                Line6 = DataTransform(investor.Id, investor.Line6, 30),
        ...
        private static string DataTransform(string id, string value, int maxLength)
        {
            var seed = id.Replace("S", "");
            ...
            return finalValue + new string(' ', (maxLength - finalValue.Length));
        }
